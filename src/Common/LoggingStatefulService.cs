...
namespace Common
{
	...
	/// </summary>
	public abstract class LoggingStatefulService : StatefulService
	{
		protected readonly ILogger _logger;

		protected LoggingStatefulService(StatefulServiceContext serviceContext, ILogger logger) : base(serviceContext)
		{
			if (logger == null)
